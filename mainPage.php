  ...
  <?php include_once 'includes/templates/headerMP.php'?>
    ...
    <div class="hero-content">
      ...
      <h1 class="hero-title">
           ...
           <span class="spanMP"> together</span>
      </h1>
    <section class="container information">
      <div class="information1">
        <h1>The house<br>of your <g>dreams</g></h1>
        <p>We specialised in knowing what our clients want without needing to sleep</p>
      </div>
      <div class="information2">
        <img class="img" src="img/interior1.jpg" alt="Interior Image 1">
      </div>
  ...
  <section class="contentVideo">
    ...
    <div class="videoBorder">
      <video class="videoH" id="vid" controls>
